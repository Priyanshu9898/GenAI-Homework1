...
python3 -m cache_replacement.policy_learning.cache_model.main --experiment_base_dir=/share/csc591s25/avbhanda/tmp --experiment_name=${experiment_name} --cache_configs=cache_replacement/policy_learning/cache/configs/default.json --model_configs=cache_replacement/policy_learning/cache_model/configs/default.json --model_bindings="loss=[\"ndcg\"]" --model_bindings="address_embedder.max_vocab_size=5000" --train_memtrace="cache_replacement/policy_learning/cache/traces/astar_313B_train.csv" --valid_memtrace="cache_replacement/policy_learning/cache/traces/astar_313B_valid.csv" --batch_size=32
